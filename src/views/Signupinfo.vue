    ...
    <el-main >
      ...
      <el-col :span="9">
        <div class="table">
          <div class="sontable">
            ...
            <el-form :model="form" :rules="rules" ref="signup" label-width="80px" :disabled="this.steps!== '1'">
              <el-form-item label="姓名" prop="name">
                <el-input type="text" placeholder="请填写考生本人真实姓名" size="small"
              ...
              <el-form-item label="身份证号" prop="sfzh">
                <el-input type="text" placeholder="请填写考生本人身份证号" size="small"
              ...
              <el-form-item label="准考证号" prop="ticket">
                <el-input type="text" placeholder="可作为登录用户名，往届考生请重新注册" size="small"
                          ...
                          v-model="form.ticket" disabled></el-input>
              </el-form-item>
              ...
              <el-form-item label="电子邮箱" prop="email">
                <el-input type="text" placeholder="密码找回和接收公告等" size="small"
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;<el-button type="danger" @click="Submit">开始报名</el-button>
      ...
      <el-col :span="9">
        <div style="margin-left: 10px;margin-top: 100px">
          <el-card style="width: 250px;height: 380px">
            <span>欢迎报名</span>
            <p>
            请报考人员认真阅读本说明，按要求填写报名表。<br>
            <span style="color:red;">注意：提交的文件为承诺书等文件，请务必上传</span>  <br>
            报考人所填写信息务必真实、准确、规范、清晰。<br>
            <span style="color:red;">请报考人员在提交前对信息的真实性进行核对，信息不实引起的相关责任由考生本人承担。</span><br>
...
export default {
    ...
    return {
      ...
      rules:{
        ...
        ticket:[
          ...
          { pattern: /^[\u4e00-\u9fa5a-zA-Z0-9]+$/,message: '准考证号不能出现特殊字符',trigger:["blur","change"] },
          { pattern: new RegExp(/^\S*$/, 'g'), message: '准考证号不能出现空格',trigger:["blur","change"] }

        ],
        tele:[
          { pattern: new RegExp(/^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/,'g'),
            message: '手机号码格式不正确',trigger:["blur","change"]}
        ],
        email:[
        ...
        zymc:[
          {required:true,message:"请选择报考学校",trigger:"blur"}
        ],
      },
      options: [
        {
  ...
  updated() {
    if( this.steps !== '1' ){     //说明已经报名
      this.$confirm('您已经报名过了，无法继续报名，是否前往报名情况界面?', '提示', {
