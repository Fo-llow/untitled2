<template>
  <div>
    ...
    <div class="block">
      ...
      <h1>网站开放时间</h1>
      <br />
      <el-table :data="timeData" style="width:520px" id="timetable">
      ...
      <br />
      <el-form :model="param"  :rules="rules2" ref="time" label-width="80px">
      ...
      <el-table :data="tableData" style="width: 720px" id="admintable">
        <el-table-column prop="account" label="管理员名" width="180" />
    ...
    <el-dialog :visible="dialogFormVisible" title="添加管理员"
               @close="dialogFormVisible=false"
               :close-on-click-modal="true" :append-to-body="true">
      <el-form :model="form" :rules="rules" ref="addadmin" label-width="80px">
        <el-form-item label="登录名" prop="username">
          <el-input type="text" placeholder="请输入新管理员登录名" size="small"
                    prefix-icon="el-icon-user"
                    v-model="form.username"></el-input>
        </el-form-item>

        <el-form-item label="密码" prop="password">
          <el-input type="password" placeholder="建议密码8位以上，且有数字，特殊字符以及大小写字母" size="small" show-password prefix-icon="el-icon-lock"
                    v-model="form.password"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="qrpassword">
          <el-input type="password" placeholder="再次确认密码。" size="small" show-password prefix-icon="el-icon-lock"
                    v-model="form.qrpassword"></el-input>
        </el-form-item>

        <el-form-item label="权限" prop="permission">
          <el-select v-model="form.permission" placeholder="请选择权限" size="large">
            <el-option
                label="超级管理员"
                value="1"
            ></el-option>
        ...
        <el-form-item label="备注" prop="note">
          <el-input type="text" placeholder="请输入该管理员的备注" size="small"
                    prefix-icon="el-icon-tickets"
                    v-model="form.note"></el-input>
        </el-form-item>

        <el-form-item label="您的密码" prop="username">
          <el-input type="password" placeholder="请输入您的密码以确认身份" size="small"
...
export default {
  ...
  methods: {
    ...
    deleteTime(){
      ...
      this.axios.post("deleteopentime",params
      ).then((response) => {
        load.close()
    ...
    SubmitAdd(){
      ...
      * */
      ...
      this.axios.post("addadmin",params
      ).then((response) => {
        load.close()
