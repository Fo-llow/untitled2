<template>
  <div >
    <template>
      <el-steps :active="steps" style="width: 800px;margin-left: 10%">
      ...
      <div v-show="steps==2" style="margin-left: 25%;margin-top: 100px">
        <template>
          ...
          <el-descriptions title="报名信息" style="width: 380px;"
            ...
            <el-descriptions-item label="报考学校">{{infoData.zymc}}</el-descriptions-item>
          ...
          <el-button type="danger" style="margin-left: 30%;margin-top: 20px" @click="modifySign">我要修改</el-button>
          </el-card>
        </template>
      </div>

      <el-dialog :visible="dialogFormVisible" title="修改报名信息"
                 @close="dialogFormVisible = false"
                 :close-on-click-modal="true" :append-to-body="true">
        <el-form :model="form" :rules="rules" ref="modifysignup" label-width="80px">
          ...
          <el-form-item label="身份证号" prop="sfzh">
            <el-input type="text" placeholder="请填写考生本人身份证号，非常重要，末位为X的请大写" size="small"
          ...
          <el-form-item label="准考证号" prop="ticket">
            <el-input type="text" placeholder="可作为登录用户名，往届考生请重新注册" size="small"
                      ...
                      v-model="form.ticket" disabled="true"></el-input>
          </el-form-item>
