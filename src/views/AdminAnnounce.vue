    ...
    <el-tabs  v-model="activeName">
      <el-tab-pane label="历史公告" name="first">
        <el-table :data="tableData" style="width: 100%" id="table">
          ...
          <el-table-column prop="file" label="公告附件" width="180"  #default="scope">
            <el-link  v-for="(f,key) in segmenteFile(scope.row.file)" :key="key" target="_blank" :href="f.fsrc" >{{f.fname}}</el-link>
          </el-table-column>
          <el-table-column prop="isemail" label="是否发送考生邮箱" width="80" />
      ...
      <el-tab-pane label="发布公告" name="second">
        <el-form :model="param" :rules="rules" ref="announce" label-width="80px">
          <el-form-item label="公告时间" prop="time">
            <el-input type="text" placeholder="建议格式为xxxx-xx-xx xx:xx:xx" size="small"
          ...
          <el-form-item label="公告作者" prop="author">
            <el-input type="text" placeholder="公告显示发布的作者" size="small"
